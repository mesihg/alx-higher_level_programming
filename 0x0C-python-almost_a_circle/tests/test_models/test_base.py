...
class TestBase(unittest.TestCase):
    ...
    def test_base_with_new_instance(self):
        b1 = Base()
    ...
    def test_base_with_type_of_instance(self):
        b6 = Base()
        self.assertEqual(type(b6), Base)
        self.assertTrue(isinstance(b6, Base))

    def test_base_with_to_json_string(self):
    ...
    def test_base_with_bad_input_to_json_string(self):
    ...
    def test_base_with_bad_args_to_json_string(self):
    ...
    def test_base_with_save_to_file(self):
    ...
    def test_base_with_bad_input_save_to_file(self):
    ...
    def test_base_with_bad_args_save_to_file(self):
    ...
    def test_base_with_from_json_string(self):
        list_input = [
    ...
    def test_base_with_bad_input_from_json_string(self):
        with self.assertRaises(TypeError) as x:
    ...
    def test_base_with_bad_args_from_json_string(self):
    ...
    def test_base_with_create(self):
        r1 = Rectangle(3, 5, 1)
    ...
    def test_base_with_bad_input_create(self):
        with self.assertRaises(TypeError) as x:
            r1 = "Hello"
    ...
    def test_base_with_load_from_file(self):
    ...
    def test_base_with_missing_files_load_from_file(self):
    ...
    def test_base_with_bad_args_load_from_file(self):
